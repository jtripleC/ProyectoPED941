namespace SolucionProyecto_PED941.Forms
{
    partial class FormSalidas
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnRegistrarSalida = new Guna.UI2.WinForms.Guna2Button();
            ...
            panelIzquierdo.Controls.Add(btnRegistrarSalida);
            ...
            txtCantidad.PlaceholderText = "Cantidad a Retirar";
            ...
            // btnRegistrarSalida
            btnRegistrarSalida.BorderRadius = 10;
            btnRegistrarSalida.CustomizableEdges = ce9;
            btnRegistrarSalida.DisabledState.BorderColor = Color.DarkGray;
            btnRegistrarSalida.DisabledState.CustomBorderColor = Color.DarkGray;
            btnRegistrarSalida.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            btnRegistrarSalida.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnRegistrarSalida.FillColor = Color.Navy;
            btnRegistrarSalida.Font = new Font("Segoe UI", 9F);
            btnRegistrarSalida.ForeColor = Color.White;
            btnRegistrarSalida.Location = new Point(95, 260);
            btnRegistrarSalida.Margin = new Padding(3, 4, 3, 4);
            btnRegistrarSalida.Name = "btnRegistrarSalida";
            btnRegistrarSalida.ShadowDecoration.CustomizableEdges = ce10;
            btnRegistrarSalida.Size = new Size(229, 37);
